...
// index last changed at: 1st Jan, 2021, 09:36 PM ( GMT-8 )
// export: named; exclusions: index, private.
// files: IDictionary, atRandom, between, camelize, capitalize, dasherize, deserialize, first, firstKey, flatten, get, guid, hash, isUuid, last, lastKey, pascalize, pathJoin, randomString, serialize, set, unique, uuid.
