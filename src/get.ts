 ...
 */
export function get<T = any>(obj: IDictionary, dotPath: string, defaultValue?: any): T {
  const parts = dotPath.split(".");
  let value: any = obj;

  parts.forEach((p) => {
    value = typeof value === "object" && Object.keys(value).includes(p) ? value[p as keyof typeof value] : undefined;
  });
